...
//==> Tabla principal
  $resultUpd = mysqli_query($Con,"SELECT
          ...
          WHERE evt.usuarios_id = $idUsuario");
//==> Tabla Espacio
  $resultEsp = mysqli_query($Con,"SELECT          spf.nombre AS espacio_fis
                                    ...
                                    WHERE evn.usuarios_id =$idUsuario");
//==> Tabla Material
...
$resultCan = mysqli_query($Con,"SELECT  evn.title      as evento_cancelado,
          ...
          <div align="center">
          <hr>
          <h3>Reporte de sistema por usuario</h3>
          <hr>
          </div>
          <div align="center">
              <table width="95%">
...
$dompdf->render();
$dompdf->stream("ReporteGeneralUsuario.pdf");
?>
