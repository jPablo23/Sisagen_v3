...
<div class="col-lg-12">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="inputName" placeholder="Capacidad del area (Numericos)" name="capacidad" min="1" require value="<?php echo $capacidad ?>">
  </div>
            ...
            $("#btnEliminar").click(function(){
                  ...
                  $("#btnEliminar").hide();
                        ...
                        //==> Guardamos por AJAX
                            $.ajax({
                                type: 'POST',
                                url: 'controller/delEsp_fis.php?id='+idRow,
...
$("#btnEliminar").hide();
        //==> Guardamos por AJAX
            $.ajax({
                type: 'POST',
                url: 'controller/udpEsp_fis.php?id='+idRow,
                data: $('#formData').serialize(),   // I WANT TO ADD EXTRA DATA + SERIALIZE DATA
                success: function(data){
                //alert("devuelve "+data);
