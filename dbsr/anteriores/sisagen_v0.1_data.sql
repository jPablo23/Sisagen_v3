...
INSERT INTO `tbl_areas` VALUES (3,'Centro de computo 1','\0',2);
...
--
-- Table structure for table `tbl_espacios_fisicos_materiales`
--
...
--
-- Dumping data for table `tbl_espacios_fisicos_materiales`
--

LOCK TABLES `tbl_espacios_fisicos_materiales` WRITE;
/*!40000 ALTER TABLE `tbl_espacios_fisicos_materiales` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_espacios_fisicos_materiales` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_roles` VALUES (1,'admin','administrador de sistema',0),(2,'tics','administrador de las tics',0),(3,'talleres y mant','personal de talleres',0),(4,'deportes','personal de deportes',0),(5,'auditorio','personal de auditorio',0);
...
INSERT INTO `tbl_usuarios` VALUES (1,'admin','admin','admin','admin','12345','admin',1,0),(2,'Usuario1','usuario','usuario','usuario','12345','usuario',2,0);
...
-- Dump completed on 2016-02-06 14:08:43
